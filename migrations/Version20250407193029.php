 ...
 */
final class Version20250407193029 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evenement (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, lieu VARCHAR(255) DEFAULT NULL, date_evenement DATETIME NOT NULL, image_evenement VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE livraison (id INT AUTO_INCREMENT NOT NULL, start_location VARCHAR(255) NOT NULL, delivery_location VARCHAR(255) NOT NULL, is_delivered TINYINT(1) DEFAULT 0 NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE offre (id_offre INT AUTO_INCREMENT NOT NULL, climatisee TINYINT(1) NOT NULL, photo VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, type_fuel VARCHAR(50) NOT NULL, nombre_places INT NOT NULL, prix NUMERIC(10, 2) NOT NULL, date_depart DATETIME NOT NULL, id_parcours INT NOT NULL, INDEX IDX_AF86866FC96A3276 (id_parcours), PRIMARY KEY(id_offre)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE package (id INT AUTO_INCREMENT NOT NULL, weight_package INT NOT NULL, description_package VARCHAR(255) NOT NULL, livraison_id INT NOT NULL, INDEX IDX_DE6867958E54FB25 (livraison_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE reponse (id INT AUTO_INCREMENT NOT NULL, date DATETIME NOT NULL, reponse LONGTEXT NOT NULL, utilisateur_id INT NOT NULL, username VARCHAR(255) NOT NULL, reclamation_id INT NOT NULL, INDEX IDX_5FB6DEC72D6BA2D9 (reclamation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE offre ADD CONSTRAINT FK_AF86866FC96A3276 FOREIGN KEY (id_parcours) REFERENCES parcours (id_parcours)');
        $this->addSql('ALTER TABLE package ADD CONSTRAINT FK_DE6867958E54FB25 FOREIGN KEY (livraison_id) REFERENCES livraison (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offre DROP FOREIGN KEY FK_AF86866FC96A3276');
        $this->addSql('ALTER TABLE package DROP FOREIGN KEY FK_DE6867958E54FB25');
