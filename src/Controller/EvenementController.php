<?php
    ...
    class EvenementController extends AbstractController
    {
        ...
        {
            // Compute stats for reserved transports.
            // Replace the sample array with your logic to calculate the actual stats.
            // For example, group reserved transports by type and count users.
            $transportStats = [
                ['type' => 'Bus', 'userCount' => 5],
                ['type' => 'Train', 'userCount' => 3],
                ['type' => 'Car', 'userCount' => 2],
            ];
            // You might also need to fetch actual users data if available
            $users = [];
